  ...
  return (
    <div className="controls">
      <div className="container controls__container">
        <div className="currentItem controls__currentItem">
          <figure className="currentItem__figure">
            <img
              src="<?=$defaultImagePath?>stations/station-1.jpg"
              alt="Example"
            />
          </figure>
          <div className="currentItem__contains">
            <span className="currentItem__name">Scratchlords</span>
            <span className="currentItem__description">
              Syllabor Selector Original mix
            </span>
            <span className="timer currentItem__timer">
              <span className="timer__count">3:24</span>/
              <span className="timer__count">5:23</span>
            </span>
          </div>
        </div>
        <div className="controls__inner">
          <button
            type="button"
            className="controls__button controls__button--volume volumeButton button"
          >
            <svg
              width={18}
              height={15}
          ...
          <div className="controls__item">
            <button
              type="button"
              className="controls__button controls__button--play playButton button"
            />
          </div>
          <button
            type="button"
            className="controls__button controls__button--source sourceButton button"
          >
            <svg
              width={15}
              height={15}
