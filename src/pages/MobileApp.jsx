...
function MobileApp() {
  return (
    <section className="container container--offset_top container--offset_left container--offset_bottom text-page">
      ...
      <p className="text">
      You can install the application on your home screen as a PWA by following the <a class="link" href="https://support.google.com/chrome/answer/9658361?co=GENIE.Platform%3DAndroid&hl=en" target="_blank">instructions</a>.
      </p>
    </section>
  );
}
